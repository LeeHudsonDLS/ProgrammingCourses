...
/* Generated from ../O.Common/basicIOCTest.dbd */
...
epicsShareExtern void (*pvar_func_register_func_myRoutine)(void);
...
int basicIOCTest_registerRecordDeviceDriver(DBBASE *pbase)
{
    const char *bldTop = "/home/jjc62351/ProgrammingCourses/EPICS/course/basicIOCTest/ioc";
    ...
    (*pvar_func_register_func_myRoutine)();
...
static const iocshFuncDef registerRecordDeviceDriverFuncDef =
                {"basicIOCTest_registerRecordDeviceDriver",1,registerRecordDeviceDriverArgs};
static void registerRecordDeviceDriverCallFunc(const iocshArgBuf *)
{
    basicIOCTest_registerRecordDeviceDriver(*iocshPpdbbase);
}
